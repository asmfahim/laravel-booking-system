                    ...
                    <form action="{{route('announcement.store')}}" method="post">
                        ...
                        <div class="row">
                            <div class=" form-group">
                                ...
                                <input class="form-control @error('title') is-invalid @enderror" id="exampleInputName1" name="title" type="text" placeholder="Enter announcement title" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label for="exampleInputName2">Notice Date</label>
                                <input class="form-control @error('notice_date') is-invalid @enderror" id="exampleInputName2" name="notice_date" type="date"  required>
                            </div>
                            <div class="col-md-6 form-group">
                                <label for="exampleInputName1">Publish Date</label>
                                <input class="form-control @error('publish_date') is-invalid @enderror" id="exampleInputName1" name="publish_date" type="date"  required>
                            </div>
                        </div>
                        <div class="row">
                            <div class=" form-group">
                                ...
                                <div class="form-check">
                                    @foreach($roles as $role)
                                        <input type="checkbox" class="form-check-input" id="checkPermission{{$role->id}}" name="message_to[]" value="{{$role->id}}">
